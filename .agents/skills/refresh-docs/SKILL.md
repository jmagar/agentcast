---
name: "refresh-docs"
description: "Use when the user asks to refresh local docs/references material, inspect the latest docs/references/CHANGES.md entry, cross-reference changed reference files against the codebase, and write docs/references/CHANGES-REPORT.md with required updates, verification, and possible new additions."
doc_type: "skill"
status: "active"
owner: "refresh-docs"
audience:
...
context: "fork"
allowed-tools: "Bash(scripts/refresh-docs.sh *), Bash(.agents/skills/refresh-docs/scripts/archive-changes-report.sh *), Bash(rg *), Bash(find *), Bash(sed *), Bash(awk *), Read, Write"
---
...
8. Before writing a new report, run `.agents/skills/refresh-docs/scripts/archive-changes-report.sh`.
