...
>
**> Note:
**> Session management (both transport-level and application-level) isaddressed separately by
[> SEP-2322
](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2322)> and
[> SEP-2567
](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2567)> . This> SEP focuses exclusively on removing the initialization handshake and providingstateless alternatives for version negotiation, discovery, and capabilities.
>
###
[​
](#protocol-version)
...
`ListRootsRequest` mechanism (see [SEP-2322](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2322)), which avoids putting
...
with `INVALID\_PARAMS` (and `400 Bad Request` for HTTP).
####
[​
](#response-streaming)
Response Streaming
These declared capabilities govern what the server may include in the response
stream. [SEP-2322](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2322) (MRTR) defines how server-to-client interactions
...
`400 Bad Request`.
```
`export const MISSING\_REQUIRED\_CLIENT\_CAPABILITY = -32003;
export interface MissingRequiredClientCapabilityError extends Omit\<
JSONRPCErrorResponse,
"error"
\> {
error: Error & {
code: typeof MISSING\_REQUIRED\_CLIENT\_CAPABILITY;
data: {
/\*\*
...
Per [SEP-2260](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2260), only notifications (not requests) flow on this
...
* `notifications/roots/list\_changed`: Removed. Roots are fetched on demand via
...
Session management is now addressed separately by [SEP-2567](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2567), which
...
decision](https://github.com/modelcontextprotocol/transports-wg/blob/main/docs/sessions-vs-sessionless-decision.md) made by the Core Maintainers.
###
[​
...
How does `server/discover` relate to the MCP Server Card?
The `server/discover` RPC overlaps with the [MCP Server Card](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2127)
