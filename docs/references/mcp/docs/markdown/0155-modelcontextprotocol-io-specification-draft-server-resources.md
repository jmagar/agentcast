...
Alternatively, if the scheme of `uri` is `https://`, clients may fetch the resource directly from the web. See the [Common URI Schemes section](#https://) for more information.
###
[​
](#resource-templates)
Resource Templates
...
[`subscriptions/listen`](/specification/draft/schema#subscriptionslistenrequest) request with the resource URIs listed in
...
`
```
See [Subscriptions](/specification/draft/basic/utilities/subscriptions) for the full protocol mechanics (acknowledgment,
