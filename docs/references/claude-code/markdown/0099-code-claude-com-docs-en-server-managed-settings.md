...
* Google Vertex AI
* Microsoft Foundry
* Custom API endpoints via `ANTHROPIC\_BASE\_URL` or [LLM gateways](/docs/en/llm-gateway)
##
[​
](#audit-logging)
Audit logging
...
|User configures a [third-party model provider](#platform-availability)|Server-managed settings are bypassed. This includes setting `CLAUDE\_CODE\_USE\_BEDROCK`, `CLAUDE\_CODE\_USE\_MANTLE`, `CLAUDE\_CODE\_USE\_VERTEX`, `CLAUDE\_CODE\_USE\_FOUNDRY`, or a non-default `ANTHROPIC\_BASE\_URL`|
