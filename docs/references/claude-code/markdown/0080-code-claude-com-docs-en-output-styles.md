...
[auto mode](/docs/en/permission-modes#eliminate-prompts-with-auto-mode) without
...
[local project level](/docs/en/settings).
...
session. Use a [subagent](/docs/en/sub-agents) when you want a separately scoped
