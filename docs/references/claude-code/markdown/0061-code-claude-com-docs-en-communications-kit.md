Communications kit - Claude Code Docs
## > Documentation Index
...
|One concrete first task chosen, a real bug or file in your codebase|Generic examples don’t convert; “fix the flaky test in `auth\_test.go`” does|
