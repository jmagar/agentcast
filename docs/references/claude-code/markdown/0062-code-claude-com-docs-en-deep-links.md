...
|Linux|`claude-code-url-handler.desktop` under `$XDG\_DATA\_HOME/applications`, defaulting to `\~/.local/share/applications`|
|Windows|`HKEY\_CURRENT\_USER\\Software\\Classes\\claude-cli`|
