...
│ Acp-Connection-Id: \<conn\_id\> │ for connection-level server→client messages
...
│ Acp-Connection-Id: \<conn\_id\> │ for sess\_abc123
...
│ ┌─────────────────────│ (SSE stream open)
│ │ │
│─── GET /acp ──────────────────────\>│ Open session-scoped GET stream for sess\_abc123
│ Acp-Connection-Id: \<new\_conn\> │
│ Acp-Session-Id: sess\_abc123 │
│ ┌─────────────────────│ (SSE stream open)
│ │ │
...
get\_stream: Option\<SseStream\>, // Connection-scoped GET stream
...
get\_stream: Option\<SseStream\>, // Session-scoped GET stream
