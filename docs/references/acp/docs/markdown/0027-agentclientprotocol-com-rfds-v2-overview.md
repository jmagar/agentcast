ACP v2 Proposal - Agent Client Protocol
[Protocol
...
* [New Prompt Lifecycle](/rfds/v2/prompt.md)
* [Message IDs](/rfds/message-id.md)
* [Fork from specified IDs](/rfds/session-fork.mds)
* [Remote Transports](/rfds/streamable-http-websocket-transport.mdx)
