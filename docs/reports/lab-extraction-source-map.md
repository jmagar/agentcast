...
| `agent-gateway` | `../lab/crates/lab/src/dispatch/gateway/index.rs`, `../lab/crates/lab/src/dispatch/gateway/dispatch.rs`, `../lab/crates/lab/src/dispatch/gateway/projection.rs`, `../lab/crates/lab/src/dispatch/gateway/runtime.rs`, `../lab/crates/lab/src/dispatch/gateway/protected_routes.rs`, `../lab/crates/lab/src/dispatch/gateway/oauth.rs`, `../lab/crates/lab/src/dispatch/gateway/oauth_lifecycle.rs`, `../lab/crates/lab/src/dispatch/gateway/types.rs`, `../lab/crates/lab/src/dispatch/gateway/virtual_servers.rs` | tool index, search/ranking, catalog diff, exposure policy, protected route policy, upstream OAuth lifecycle orchestration, view model redaction, routing, and GatewayManager runtime impls exposed in the snapshot | virtual Lab service catalog and homelab service-backed virtual servers |
